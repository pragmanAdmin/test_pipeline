...
from pragman.misc.utils import dict_to_object

logger = logging.getLogger(__name__)


class pragmanConfiguration(BaseSettings):
    configuration: Optional[Dict[str, Any]] = None
    config_path: Optional[str] = Field(None, env="pragman_config_path")
    config_filename: Optional[str] = Field(None, env="pragman_config_filename")
