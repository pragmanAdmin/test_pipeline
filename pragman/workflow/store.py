...
from pragman.misc.utils import obj_to_json
from pragman.workflow.base_store import BaseStore
from pragman.workflow.workflow import WorkflowState, WorkflowConfig, Workflow
...
class WorkflowStore(BaseStore):
    ...
    def __init__(self, url: str = "sqlite:///pragman.db", **data: Any):
        super().__init__(**data)
